...
shinyUI(
    ...
    fluidRow(column(4,
                    ...
                    htmlOutput("text_inkomst"),
                    sliderInput("boxInc", "", value = 200000, min=0, max=2000000, step=1000, ticks=FALSE, width="95%"),
                    ...
                    sliderInput("boxInflation", "Uppskattad inflation", value = 0.02, min=0, max=1, step=.01, ticks=FALSE, width="95%"),
